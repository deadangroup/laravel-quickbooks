...
namespace Deadan\QuickBooks\Http\Controllers;
...
use Mockery;
use Mockery\Mock;
use Deadan\QuickBooks\Client as QuickBooks;
use Deadan\QuickBooks\TestCase;

/**
 * Class ControllerTest
 *
 * @package Deadan\QuickBooks\Http\Controllers
 */
